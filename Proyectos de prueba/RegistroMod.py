...
#     sender_email = "alertadeseguridad176@gmail.com"
#     receiver_email = "alertadeseguridad176@gmail.com"
#     password = "thuy pjpd rkff jynq"  # Asegúrate de que esta sea la contraseña de aplicación correcta
    
#     log_line = ""
#     now = datetime.now().strftime('%Y-%m-%d %H:%M:%S')

#     # Crea el mensaje
#     msg = MIMEText(now + " | Han iniciado sesión en el sistema |")
#     msg['Subject'] = "ALERTA DE SEGURIDAD " + now
#     msg['From'] = sender_email
#     msg['To'] = receiver_email
    
#     foto = r"C:\Users\lucac\Escritorio\Nueva carpeta\Python\Proyectos de prueba\foto_capturada.jpg"
#     # Envía el correo
#     try:
#         with smtplib.SMTP('smtp.gmail.com', 587) as server:
#             server.starttls()  # Inicia la conexión segura
#             server.login(sender_email, password)
#             server.sendmail(sender_email, receiver_email, msg.as_string(), foto)  # No codificar aquí
